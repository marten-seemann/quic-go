...
TEMP_DIR=$(mktemp -d)
mkdir -p $TEMP_DIR/src/github.com/marten-seemann/quic-go/internalpackage

cp -r $GOPATH/src/github.com/marten-seemann/quic-go/internal/* $TEMP_DIR/src/github.com/marten-seemann/quic-go/internalpackage
